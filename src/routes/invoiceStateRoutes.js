...
/**
 * @swagger
 * /api/invoices/{id}/state:
 *   get:
 *     operationId: getInvoiceState
 *     summary: Get invoice state and allowed transitions
 *     description: Returns the current lifecycle state for an invoice along with the set of states it may transition to next.
 *     tags: [InvoiceState]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Invoice state retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/InvoiceStateResponse'
 *       404:
