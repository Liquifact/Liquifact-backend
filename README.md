...
For the invoice state machine, KYC-gated escrow linking, and `POST /api/invest/fund-invoice` sequence diagrams, see **[`docs/invoice-lifecycle.md`](./docs/invoice-lifecycle.md)**.
